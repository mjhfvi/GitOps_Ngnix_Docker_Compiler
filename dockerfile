...
# Verify Chocolatey is installed with version check
RUN choco --version
...
# Clone Nginx Repository from github
...
# Output Nginx Version to Screen
RUN C:/nginx/objs/nginx.exe -v

# Build Docker Image Nginx Based on Windows Nano 2019
FROM mcr.microsoft.com/windows/nanoserver:ltsc2019

# Building Folder Structure for Nginx Image
RUN mkdir C:\nginx C:\nginx\conf C:\nginx\logs C:\nginx\temp

# Copy Nginx Files from the Previous Build Stage
